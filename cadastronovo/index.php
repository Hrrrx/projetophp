...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">Alunos</a>
      <button class="btn btn-link btn-sm text-white order-1 order-sm-0" id="sidebarToggle" href="#">
        <i class="fas fa-bars"></i>
      </button>
      <h3 class="cabecalho">Cadastro de Aluno</h3>
      <!-- Navbar Search -->
...
<!--- ////////////////////////////////// -->
<div class="row ">
  <form action="db/create.php" method="POST"class="col-12"> <!--col s12 ,smp 12 colunas-->
...
<!--Noome aluno-->
<div class="campo form-group col-12">
...
<button type="submit" name="" value="apagar" class="btn btn-danger"/>Apagar</button>
</div>
</fieldset>
</form>
</div>
